			...
			<table id='main-table'>
				<tr>
					...
					<td id='blogies'>
						...
						<!--<h2>8 downloads</h2>-->
							...
							<h3 class='autor'>Author: <a href='$author2'>Christina Yorgova</a></h3>
						<p class='separate'>
						...
						<div class='separate'>
							<a href='conf_Simplicity.html'>Download</a>
						</div>
					</td>
					<td>
					</td>
				...
				<tr>
					...
					<td id='blogies'>
						...
						<div class='separate'>
							<a href='conf_Blogly.html'>Download</a>
						</div>
					</td>
					<td>
					</td>
				...
				<tr>
					...
					<td id='blogies'>
						...
						<div class='separate'>
							<a href='conf_Blue.html'>Download</a>
						</div>
					</td>
					<td>
					</td>
...
<!--
				...
				<tr>
					...
					<td id='blogies'>
						<h1>Blue</h1>
						<img src='Library/Blogies/Blogy-Gero.png' />
						<p>
							Blue is free and simple Blogy template.<br>
							...Notes...
						</p>
						<div class='separate'>
							<a href='#'>Download</a>
